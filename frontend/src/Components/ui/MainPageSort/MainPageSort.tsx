...
function MainPageSort() {
  ...
  return (
    <div className="text-center">
      <h1 className="uppercase text-xl p-8">Популярные Товары</h1>
      <div className="pointer ">
        <span className="p-10">
          <ul className="flex px-10 font-medium lg:flex-row lg:space-x-8 mt-0">
            <li className="relative group">
              <span
                className="  px-10 lg:text-black border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 "
                aria-current="page"
              >
                хит продаж
              </span>
