          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl">
            ...
            <a href="/#" className="flex items-center">
              ...
              <button
                ...
                type="button"
                className="inline-flex items-center p-2 ml-1 text-sm rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200  dark:focus:ring-gray-200"
