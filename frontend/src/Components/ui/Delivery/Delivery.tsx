...
const Delivery: React.FC = () => {
    ...
    return (
        <Container>
            <h1 className="mt-20 mb-10 text-2xl font-normal leading-9">ДОСТАВКА И ОПЛАТА</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pb-10 mb-10 ">
                <div className="text-center flex border border-rose-300 p-8 items-center rounded-tl-lg">
                ...
                <div className="text-center flex border border-rose-300 p-8 items-center rounded-tr-lg">
                ...
                <div className="text-center flex border border-rose-300 p-8 items-center rounded-bl-lg">
                ...
                <div className="text-center flex border border-rose-300 p-8 items-center rounded-br-lg">
